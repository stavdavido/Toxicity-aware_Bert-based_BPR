# Toxicity-aware_BERT-based-BPR

#The code is organized into three separate directories, each with a specific purpose:
...
#The TBBPR folder contains the source code for the primary, proposed model itself.
